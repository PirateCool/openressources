...
ActiveRecord::Schema.define(version: 2019_04_04_123810) do
  ...
  create_table "projects_ressources", id: false, force: :cascade do |t|
    t.integer "project_id"
    t.integer "ressource_id"
    t.index ["project_id"], name: "index_projects_ressources_on_project_id"
    t.index ["ressource_id"], name: "index_projects_ressources_on_ressource_id"
  end
